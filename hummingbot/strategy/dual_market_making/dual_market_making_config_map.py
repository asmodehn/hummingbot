...
def maker_trading_pair_prompt():
    exchange = dual_market_making_config_map.get("exchange").value
...
def order_amount_prompt() -> str:
    exchange = dual_market_making_config_map["exchange"].value
    trading_pair = dual_market_making_config_map["market"].value
...
dual_market_making_config_map = {
    "strategy":
        ConfigVar(key="strategy",
                  prompt=None,
                  default="dual_market_making"),
    "exchange":
    ...
    "order_level_amount":
        ConfigVar(key="order_level_amount",
                  ...
                  required_if=lambda: dual_market_making_config_map.get("order_levels").value > 1,
                  type_str="decimal",
    ...
    "inventory_target_base_pct":
        ConfigVar(key="inventory_target_base_pct",
                  ...
                  required_if=lambda: dual_market_making_config_map.get("inventory_skew_enabled").value,
                  type_str="decimal",
    ...
    "ask_order_optimization_depth":
        ConfigVar(key="ask_order_optimization_depth",
                  ...
                  required_if=lambda: dual_market_making_config_map.get("order_optimization_enabled").value,
                  type_str="decimal",
