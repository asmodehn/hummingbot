...
from .dual_market_making_order_tracker import DualMarketMakingOrderTracker
...
cdef class DualMarketMakingStrategy(StrategyBase):
    ...
    def __init__(self,
        ...
        super().__init__()
        self._sb_order_tracker = DualMarketMakingOrderTracker()
    ...
    cdef c_tick(self, double timestamp):
        ...
        try:
            ...
            if self._create_timestamp <= self._current_timestamp:
                ...
                # 6. We do not have any external price source (cf. pure_mm)
